...
#define RMP_WHEEL_COUNT_PER_M		33215.0
#define RMP_YAW_COUNT_PER_REV           112644.0
#define RMP_GYRO_COUNT_PER_DEG		7.8
#define RMP_GYRO_COUNT_PER_DEG_PER_S	7.8
#define RMP_WHEELSPEED_COUNT_PER_M_PER_S 332.0
#define RMP_YAWSPEED_COUNT_PER_REV_PER_S RMP_YAW_COUNT_PER_REV/40
// was 332.0*0.27*2.0*M_PI*2.0

#define RMP_WHEEL_RADIUS                0.2365
...
// command a rotation of 90 counts/sec
// takes 32 sec to go 1 rev
// 90 counts/sec * 32 sec/rev = 2880 counts/rev
...
//#define LOG_402_PACKETS
#ifdef LOG_402_PACKETS
      printf("CAN packet added: %s\n", pkt.toString());
#endif
      break;
